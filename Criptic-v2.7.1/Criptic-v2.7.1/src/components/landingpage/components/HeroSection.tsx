...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-green-400 via-purple-500 to-blue-500 text-white p-16 text-center">
      ...
      <p className="mb-8 mt-4 w-8/12 m-auto text-lg">A decentralized networking platform based on smart contracts, together with NFT technology, whichbrings people together from all over the world andopens up endless possibilitiesnew economic financial systems</p>
